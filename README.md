...
```
Ввод: x = 2```
Результат: Write -> 5 (так как y = 5 * 2 + 3 = 13 > 10, выводится 13)```
Ввод: x = 1```
Результат: Write -> 5 (так как y = 8, выполняется else, выводится a = 5)
...
| Участник           | Задачи                                                                 |
|--------------------|------------------------------------------------------------------------|
| Долов Вячеслав     | Таблица идентификаторов, структура программы, пользовательский интерфейс |
